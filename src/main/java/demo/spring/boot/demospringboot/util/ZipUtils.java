...
public class ZipUtils {
     ...
     * @throws IOException
     */
    public static ZipOutputStream compress(ZipOutputStream zipOutputStream, String fileName, byte[] content) throws IOException {
    ...
    public void test() throws IOException {
        ZipOutputStream zipOutputStream = new ZipOutputStream(new FileOutputStream("d:/test2.zip"));

        ZipUtils.compress(zipOutputStream, "xx", "xx".getBytes());
        ZipUtils.compress(zipOutputStream, "zz", "zz".getBytes());
