...
public class ShellUtil {
     ...
     * @return
     */
    public static <T> T executeLinuxShell(String cmdarray[], Function<InputStream, T> function) {
        log.info("sh is :{}", cmdarray);
        Runtime run = Runtime.getRuntime();
        InputStream in = null;
        T result = null;
        try {
     ...
     * @return
     */
    public static String executeLinuxShellStr(String sh, Function<InputStream, String> function) {
        String shell = sh;
        log.info("sh is :{}", shell);
        Runtime run = Runtime.getRuntime();
        InputStream in = null;
     ...
     * @return
     */
    public static <T> T executeLinuxShellStr(String cmdarray[], Function<InputStream, T> function) {
        log.info("sh is :{}", cmdarray);
        Runtime run = Runtime.getRuntime();
        InputStream in = null;
        T result = null;
     ...
     * @return
     */
    public static List<String> getResult(String cmdarray[]) {
        return ShellUtil.executeLinuxShellStr(cmdarray, inputStream -> {
            Reader reader = new InputStreamReader(inputStream);
            LineNumberReader lineNumberReader
                    = new LineNumberReader(reader);
            List<String> list;
...
//        pb.redirectOutput(ProcessBuilder.Redirect.appendTo(log2));
    ...
    public static class LocalFun implements Function<InputStream, String> {
        @Override
